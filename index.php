...
<head>
    ...
    <link rel="stylesheet" href="assets/css/pop-balloon.css?v={{time()}}">
    <link rel="stylesheet" href="assets/css/confetti.css?v={{time()}}">
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-413TWQC025"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-413TWQC025');
    </script>
